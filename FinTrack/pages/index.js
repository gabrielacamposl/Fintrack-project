      ...
      <div className='px-4 py-8 md:px-6 lg:px-10' style={estiloDelFondo}>
        <components.Container className={`card m-auto mt-8 ${styles.card}`} >
          ...
          <components.SignInContainer className={`card ${styles.card}`} signinIn={signIn}>
            ...
            <components.Form >
              <Image src={logo} className={styles['logo']} alt="Mi imagen" priority={true} style={{ width: '80px', height: '80px' }}  />
              ...
              <InputText
                ...
                type="text" placeholder="Correo electrónico" className={`block text-900  mb-2 w-8 p-3  ${estiloEmail} rounded-lg` }
              />
              ...
              className="mb-2 w-8 p-3 text-xl" onClick={validarEnvio} />
          ...
          {/* <components.OverlayContainer signinIn={signIn}  style={{ left: "30%", width: "40%" }}>
            <components.Overlay signinIn={signIn} >
